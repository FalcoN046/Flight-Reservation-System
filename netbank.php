...
<div class="container" style="text-align-last: center;">
    <div class="row">
        <div class="jumbotron">
          <h1 class="text-center" style="color: #ff4427">Net-Banking</h1>
          <p class="text-center" style="color: #ff4427">Enter your payment details below.</p>
        </div>
    </div>
    <div class="row">
            ...
            <div class="credit-card-div">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div>
                    <h>Enter the Bank Name</h><br>
                    <input list="destinations" name="destination" placeholder="BANK NAME" required>
                        ...
                        <div style="text-align-last: center;">
                            <div style="text-align-last: center;" >
                             <a><input type="button" value="PAY NOW" type="submit" name="Pay_Now"  style="color: #ff4427;"onclick="window.location.href='/airline-ticket-reservation/ticket_success.php'" />
                              <!-- <input type="submit" value="Pay Now" name="Pay_Now" style="color: #ff4427;"> -->
                             </a>
