...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version">
		...
		<br>
		<br>
		<form class="float_form" style="padding-left: 40px ;text-align-last: center;" action="del.php" 
        method="POST">
			<fieldset>
				<legend style="color: #eb4034">Seat No:-</legend>
				
				<input type="text" style="color: #eb4034" name="name" placeholder="Enter Seat No." required><br><br>
				
				<br>
				
				<!-- <input type="submit" name="done"  value="GO"> -->
				
                <input type="button" value="DELETE" name="sumbit" type="submit"  style="color: #ff4427;"onclick="window.location.href='/airline-ticket-reservation/del.php'" />
			</fieldset>
			<br>
