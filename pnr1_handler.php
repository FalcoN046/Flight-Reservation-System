...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                       <li><a class="active" href="/airline-ticket-reservation/customer_homepage.php" style="color: #ff4427">Home</a></li>
                        ...
                        <li><a href="/airline-ticket-reservation/need.php" style="color: #ff4427">Logout</a></li>
  ...
  <fieldset style="text-align-last: center;">
   ...
   <h1 style="color: #ff4427;text-align-last: center;" > Ticket Details -VOYAGE AIR </h1>  
...
<?php
 ...
 $q = "SELECT * from ticket_details where pnr='$pnr' ";
...
<?php
 $q = "SELECT * FROM payment_details where pnr='$pnr' ";
 $query = mysqli_query($con,$q);
  while($res = mysqli_fetch_array($query)){
 ?>
 <tr class="bg-white text-dark text-center">
...
<?php
 ...
 // $q = "SELECT * FROM passengers where pnr='$pnr' ";
 ...
 <td> <?php echo $res['meal_choice'];  ?> </td>
...
<!-- <a title="Print Screen"    style="" >PRINT BUTTON</a> -->

<!-- <input value="PRINT" target="_blank" alt="Print Screen" onclick="window.print();" style="color:#ff4427;background-color:white ;cursor:pointer;text-align-last: center;" /> -->
</fieldset>
<!-- <input  type="BUTTON"  /> -->
<br>
<br><br>
<div style="text-align-last: center;">
<button value="PRINT" onclick="window.print();" style="color:#ff4427;background-color:white;">PRINT</button>
</div>
  </body>
 </html>
