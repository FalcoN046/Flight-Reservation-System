...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <fieldset>
		<form action="deactivate_jet_details_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color: #ff4427">ENTER THE AIRCRAFT TO BE DEACTIVATED</h2>
			<div>
			<?php
			...
			<div>
					...
					<h>Enter a valid Jet ID</h>

				
					<input type="text" name="jet_id"  required placeholder="Jet ID" style="color: #ff4427">
				</div>
			
			<br>
			<input type="submit" value="Deactivate" name="Deactivate" style="color: #ff4427">
			</div>
