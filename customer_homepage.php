											...
											<div class="panel-body bk-primary text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/airplane1.jpg" alt="" width="250" height="200">
														</div>
												</div>
											</div>
											<a href="book_tickets.php" class="block-anchor panel-footer">Book Flight Tickets<i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
															<img src="/airline-ticket-reservation/img/booked.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="view_booked_tickets.php" class="block-anchor panel-footer text-center">View Booked Flight &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													...
													<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/cancel.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="cancel_booked_tickets.php" class="block-anchor panel-footer text-center">"cancel_booked_tickets.php" &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/tickets.webp" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="pnr1.php" class="block-anchor panel-footer text-center">Get Flight Ticket &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
