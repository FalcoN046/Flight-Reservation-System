...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version">
		...
		<form action="delete_flight_details_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color: #ff4427" >ENTER THE FLIGHT SCHEDULE TO BE DELETED</h2>
			<div>
			<?php
			...
			?>
				...
				<div>	
					...
					<input style="color: #ff4427" type="date" name="departure_date" required>
				</div>
			...
			<br>
			<br>
			<input type="submit" style="color: #ff4427" value="Delete" name="Delete">
			</div>
		</form>
	</body>
</html>