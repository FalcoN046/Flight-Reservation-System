...
<html>
    ...
    <body>
        <header class="header header_style_01" style="background-color: white">
        <nav class="megamenu navbar navbar-default" style="background-color: white">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="background-color: white">
                    <ul class="nav navbar-nav" style="background-color: white">
                        ...
                        <li><a href="customer_homepage.php" style="color: #ff4427">Back</a></li>    
                    </ul>
        ...
        <h2 style="text-align-last: center;color:#ff4427 ">VIEW BOOKED FLIGHT TICKETS</h2>
        <h3 class='set_nice_size'><center><u style="text-align-last: center;color:#ff4427 ">Upcoming Trips</u></center></h3>
        ...
        <?php
            ...
            $query="SELECT pnr,date_of_reservation,flight_no,journey_date,class,booking_status,no_of_passengers,payment_id FROM Ticket_Details where customer_id=? AND journey_date>=? AND booking_status='CONFIRMED' ORDER BY  journey_dat where pnr=$pnr ";
