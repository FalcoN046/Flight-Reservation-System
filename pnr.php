...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version">
		...
		<form class="float_form" style="padding-left: 40px ;text-align-last: center;" action="login_handler.php" method="POST">
			<fieldset>
				<legend style="color: #eb4034">PNR:-</legend>
				<strong >PNR:</strong><br>
				<input type="text" style="color: #eb4034"name="Pnr" placeholder="Enter PNR" required><br><br>
				...
				<?php
					...
					{
						echo "<br>
						<strong style='color:red'>Invalid PNR</strong>
						<br><br>";
					}
				?>
				<input type="submit" name="pnr" value="GO">
			</fieldset>
			<br>
