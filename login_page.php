...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version">
		...
		<br>
		<br>
		<form class="float_form" style="padding-left: 40px ;text-align-last: center;" action="login_handler.php" method="POST">
			<fieldset>
				<legend style="color: #eb4034">Login Details:-</legend>
				<strong >Username:</strong><br>
				<input type="text" style="color: #eb4034"name="username" placeholder="Enter your username" required><br><br>
				<strong>Password:</strong><br>
				<input type="password" style="color: #eb4034" name="password" placeholder="Enter your password" required><br><br>
				<strong>User Type:</strong><br>
				Customer <input type='radio' name='user_type' value='Customer' style="color: #eb4034"checked/> Administrator <input type='radio' name='user_type' value='Administrator'/>
				<br>
				<?php
