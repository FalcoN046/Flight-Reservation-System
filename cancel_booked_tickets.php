...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <fieldset>
		<form action="cancel_booked_tickets_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color:#ff4427 ">CANCEL BOOKED TICKETS</h2>
			<?php
			...
			?>
					...
					<h style="color:#ff4427 "> Enter the PNR</h>
				
					<input type="text" name="pnr" required>
			
			<br>
            <br>
			<input type="submit" style="color:#ff4427 " value="Cancel Ticket" name="Cancel_Ticket">
		</form></fieldset>
