...
<div class="container" style="text-align-last: center;">
    <div class="row">
        <div class="jumbotron">
          <h1 class="text-center" style="color: #ff4427">Online Payment</h1>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5 class="text-muted" style="color: #ff4427"> Credit Card Number</h5>
                            </div>
                        ...
                        <div style="text-align-last: center;">
                            <div style="text-align-last: center;" >
                             <a><input type="button" value="PAY NOW" name="Pay_Now" style="color: #ff4427;"onclick="window.location.href='/airline-ticket-reservation/ticket_success.php'" />
