            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="need.php" style="color: #ff4427">Logout</a></li>
                    </ul>
											...
											<div class="panel-body bk-primary text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/list.jpg" alt="" width="250" height="200">
														</div>
												</div>
											</div>
											<a href="admin_view_booked_tickets.php" class="block-anchor panel-footer"> View List of Booked Tickets<i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
															<img src="/airline-ticket-reservation/img/schedule.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="add_flight_details.php" class="block-anchor panel-footer text-center">Add Flight Schedule Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													...
													<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/delete.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="delete_flight_details.php" class="block-anchor panel-footer text-center">Delete Flight Schedule Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/add.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="add_jet_details.php" class="block-anchor panel-footer text-center">Add Aircrafts Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/activate.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="activate_jet_details.php" class="block-anchor panel-footer text-center"> Activate Aircraft &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												<div class="stat-panel-number h1 "></div>
													<div class="stat-panel-title text-uppercase">
														<img src="/airline-ticket-reservation/img/deactivate.jpg" alt="" width="250" height="200">
													</div>
												</div>
											</div>
											<a href="deactivate_jet_details.php" class="block-anchor panel-footer text-center">Deactivate Aircraft &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
