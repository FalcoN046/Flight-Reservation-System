...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <fieldset>
		<form action="admin_view_booked_tickets_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color:#ff4427 ">VIEW LIST OF BOOKED TICKETS FOR A FLIGHT</h2>
			<div>
			
				<div>
					<h>Enter the Flight No.</h>
					<input type="text"  style="color:#ff4427" name="flight_no" required placeholder="">
				</div>
				<br>
				<br>
				<div>
					<h >Enter the Departure Date</h>
					<input type="date" style="color:#ff4427" name="departure_date" required placeholder="departure_date">
				</div>
			<br>
			<br>
			<div style="color:#ff4427  ">
			<input type="submit" value="Submit" name="Submit" style="background-color:#ff4427;color: white;border-radius: 6px ">
		</div>
			</div>
		</form>
		</fieldset>
