...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version">
		...
		<br>
		<br>
		<form class="float_form" style="padding-left: 40px ;text-align-last: center;" action="pnr1_handler.php" method="POST">
			<fieldset>
				<legend style="color: #eb4034">PNR:-</legend>
				<strong >PNR:</strong><br>
				<input type="text" style="color: #eb4034" name="name" placeholder="Enter PNR" required><br><br>
				
				<br>
				
				<!-- <input type="submit" name="done"  value="GO"> -->
				<input type="submit" value="GO"  name="sumbit"  style="color:white;background-color:  #ff4427;"onclick="window.location.href='pnr1_handler.php'" />
			</fieldset>
			<br>
