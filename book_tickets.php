...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	...
	<body class="host_version" style="text-align-last: center;">
		...
		<form action="view_flights_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color:#ff4427 ">SEARCH FOR AVAILABLE FLIGHTS</h2>
			<br>
			
				<div>
					<h>Enter the Origin</h><br>
			...
			<br>
				<div>
					<h>Enter the Departure Date</h><br>
						<h><input type="date" name="dep_date" min=
						<?php 
				...
				<div>
					<h>Enter the No. of Passengers</h><br>
