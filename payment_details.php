	...
	<body class="host_version">
		...
		<form action="payment_details_form_handler.php" method="post">
			...
			?>
					...
					<strong style="color: #ff4427;">Enter the Payment Mode:-</strong>
					<br>
					<br>
				...
				<div>
				<input type="button" value="CARD" type="submit"  style="color: #ff4427;margin-left: 100px"onclick="window.location.href='/airline-ticket-reservation/onlinepay.php'" />
				</div>
				<br>
				<div>
				<input type="button" value="NETBANKING" type="submit"  style="color: #ff4427;margin-left: 100px"onclick="window.location.href='/airline-ticket-reservation/netbank.php'" />
				</div>
			
			<br>
		<input type="button" value="BACK" type="submit" clas="btn" style="color: #ff4427;margin-left: 100px"onclick="window.location.href='/airline-ticket-reservation/book_tickets2.php'" />
