...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                         <li><a class="active" href="/airline-ticket-reservation/admin_homepage.php" style="color: #ff4427">Home</a></li>
                        
                        <li><a href="admin_homepage.php" style="color: #ff4427">Back</a></li>
    ...
    <fieldset>
		<form action="add_jet_details_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color: #ff4427 ">ENTER THE AIRCRAFTS DETAILS</h2><br>
			<div>
			<?php
			...
			?>
				<div>
					<h style="color: #ff4427 ">Enter a valid Jet ID</h>
				
				
					<input type="text" name="jet_id" required placeholder="Jet ID">
				</div>
			...
			<br>
				<div>
					...
					<h style="color: #ff4427 ">Enter the Jet Type/Model</h>
				
					<input type="text" name="jet_type" required placeholder="Jet Type/Model">
				</div>
				
			<br>
			
				<div>
					<h style="color: #ff4427 ">Enter the total capacity of the Jet</h>
				
					<input type="number" name="jet_capacity" required placeholder="capacity">
				</div>
				
			
			<br>
			<br>
			<input type="submit" value="Submit" name="Submit" style="color:#ff4427 ">
			</div>
		</form>
		</fieldset>
	</body>
