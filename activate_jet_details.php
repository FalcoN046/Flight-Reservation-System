...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <fieldset>
		<form action="activate_jet_details_form_handler.php" method="post" style="text-align-last: center;">
			<h2 style="color: #ff4427">ENTER THE AIRCRAFT TO BE ACTIVATED</h2>
			<div>
			<?php
			...
			<br>
			<input type="submit" value="Activate" name="Activate" style="color: #ff4427">
			</div>
		</form>
		</fieldset>
	</body>
